...
from substrate.cli._common import console

app = typer.Typer(
    help="Substrate — typed CLI for the Substrate On-Demand GPU platform.",
...
def _version_callback(value: bool) -> None:
    if value:
        console.print(f"substrate {__version__}")
        raise typer.Exit()
