...
from substrate._http.errors import NotFoundError, SubstrateError
...
from substrate.models.launch_config import LaunchConfiguration
from substrate.resources._base import unwrap

_log = get_logger("substrate.instances")
...
class InstancesManager:
    ...
    def delete_many(self, instance_ids: Iterable[UUID | str]) -> list[Instance]:
        ...
        errors: list[tuple[str, SubstrateError]] = []
    ...
    def wait_until_active(
        ...
        *,
        ...
        Raises:
          ...
          SubstrateError: if the instance enters `deleting` or `deleted`.
        """
