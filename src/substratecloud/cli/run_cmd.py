"""`substratecloud run` — launch a workload and wait until the instance is active."""
...
from substratecloud.cli._common import console, err_console, handle_errors, make_client
...
def register(app: typer.Typer) -> None:
    ...
    def run(
        ...
        console.print(
            ...
            "Use `substratecloud destroy` for manifest-driven launches.[/dim]"
        )
    ...
    def _load_workload(path: Path):
        ...
        if kind == "docker":
            from substratecloud.workloads.docker import from_dict
